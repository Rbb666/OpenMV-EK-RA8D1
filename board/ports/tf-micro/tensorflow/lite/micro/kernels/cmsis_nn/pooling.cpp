...
TFLMRegistration Register_AVERAGE_POOL_2D() {
  return tflite::micro::RegisterOp(pooling::Init, pooling::AveragePrepare, pooling::AverageEval);
}

TFLMRegistration Register_MAX_POOL_2D() {
  return tflite::micro::RegisterOp(pooling::Init, pooling::MaxPrepare, pooling::MaxEval);
}
